...
export function CompactionEvent({ data }: { data: CompactionData }) {
  return (
    <div
      className="flex items-center gap-2 mx-5 my-2 px-3 py-1.5 rounded-md bg-amber-50/80 border border-amber-200/60 text-[11px] text-amber-700"
    >
